...
#[get("/meetings")]
pub async fn get_teacher_meetings(req: HttpRequest,pool: web::Data<Arc<Pool<MySql>>>,query: web::Query<TeacherSubjectQuery>)-> impl Responder {
    ...
    _ = sqlx::query(templates::SET_ISOLATION_QUERY)
        ...
        .await;
    let result: Result<Vec<TeacherMeetings>, sqlx::Error> = sqlx::query(templates::TEACHER_MEETINGS_PER_DESCIPLINE)
