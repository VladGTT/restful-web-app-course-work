...
#[get("/subjects")]
pub async fn get_teacher_subjects(req: HttpRequest,pool: web::Data<Arc<Pool<MySql>>>)-> impl Responder {
    ...
    let result: Result<Vec<TeacherSubjects>, sqlx::Error> = sqlx::query(templates::TEACHER_TAUGHT_DISCIPLINES)
